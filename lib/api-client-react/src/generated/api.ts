 ...
 */
export const getGetMoodAnalysisUrl = () => {
  return `/api/analytics/mood`;
};

export const getMoodAnalysis = async (
  options?: RequestInit,
): Promise<MoodAnalysis> => {
  return customFetch<MoodAnalysis>(getGetMoodAnalysisUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetMoodAnalysisQueryKey = () => {
  return [`/api/analytics/mood`] as const;
};

export const getGetMoodAnalysisQueryOptions = <
  TData = Awaited<ReturnType<typeof getMoodAnalysis>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getMoodAnalysis>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetMoodAnalysisQueryKey();

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getMoodAnalysis>>> = ({
    signal,
  }) => getMoodAnalysis({ signal, ...requestOptions });
...
export type GetMoodAnalysisQueryResult = NonNullable<
  Awaited<ReturnType<typeof getMoodAnalysis>>
>;
export type GetMoodAnalysisQueryError = ErrorType<unknown>;

/**
 * @summary Customer mood/sentiment breakdown from ratings and reviews
 */

export function useGetMoodAnalysis<
  TData = Awaited<ReturnType<typeof getMoodAnalysis>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetMoodAnalysisQueryOptions(options);
